...
import controlador.ControladorListarCurso;
 ...
 */
public class VistaListarCurso extends JFrame {

	private ControladorListarCurso vistaComponent;
	private JPanel panel;
	private JLabel lTitulo;
	private JButton bSalir, bVolver;
	private ImageIcon iDimAux, iSalir;

	public VistaListarCurso(ControladorListarCurso controladorListarCurso) {
		this.vistaComponent = controladorListarCurso;
	...
	private void crearJLabel() {
		lTitulo = new JLabel("LISTA DE LOS CURSOS");
...
}// end VistaListarCursoistaListarCurso